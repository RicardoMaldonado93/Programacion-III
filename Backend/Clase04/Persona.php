<?php
    ...
    class Persona
    {
        ...
        {
            //con esta funcion se logra obtener el nombre y extension del mismo.
            $arch = $_FILES;
        ...
        {
            /*con esta funcion se logra borrar un registro, para ello lo que hace es 
              abrir el archivo en modo lectura, copiar los regitros en un array para luego 
              trabajar con ellos, luego busca el indice en donde se encuentra el registro
              para obtener la extension de la imagen de la misma para luego borrarla, una vez
              realizado esto se cierra el archivo para poder abrirlo en modo escritura, luego de esto
              se procede a reescribir todos los registros. 
            */
            $var = fopen("./BD.txt",'r');
            $lista= array();
            $listaaux = array();
